...
print("===== 173_SQL_Record_Manager_TXT_RAG實驗 =====\n")
...
TARGET_DIR = os.path.join(BASE_DIR, "multi_txt")

# Database Directory（資料庫資料夾）
DB_DIR = os.path.join(BASE_DIR, "newsdb_txt")

# SQL Database Path（SQL 資料庫路徑）
SQL_DB_PATH = f"sqlite:///{os.path.join(BASE_DIR, 'record_manager_txt.sql')}"
...
if all_docs:
    ...
    print("=" * 50)
    print("SQL 記錄檔：")
    print(os.path.join(BASE_DIR, "record_manager_txt.sql"))

else:
    print("=" * 50)
    print("資料夾內沒有任何 txt 檔案")
    print("=" * 50)
    print("無法建立資料庫")
