...
print("===== 176_SQL_Record_Manager_PPT_RAG實驗 =====\n")
...
TARGET_DIR = os.path.join(BASE_DIR, "multi_ppt")

# Database Directory（資料庫資料夾）
DB_DIR = os.path.join(BASE_DIR, "newsdb_ppt")

# SQL Database Path（SQL 資料庫路徑）
SQL_DB_PATH = f"sqlite:///{os.path.join(BASE_DIR, 'record_manager_ppt.sql')}"
...
# Search Path（搜尋路徑）
search_path = os.path.join(TARGET_DIR, "*.pptx")
...
if all_docs:
    ...
    print("=" * 50)
    print("SQL 記錄檔：")
    print(os.path.join(BASE_DIR, "record_manager_ppt.sql"))

else:
    print("=" * 50)
    print("資料夾內沒有任何 pptx 檔案")
    print("=" * 50)
    print("無法建立資料庫")
