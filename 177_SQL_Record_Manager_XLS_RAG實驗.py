...
print("===== 177_SQL_Record_Manager_XLS_RAG實驗 =====\n")
...
TARGET_DIR = os.path.join(BASE_DIR, "multi_xls")

# Database Directory（資料庫資料夾）
DB_DIR = os.path.join(BASE_DIR, "newsdb_xls")

# SQL Database Path（SQL 資料庫路徑）
SQL_DB_PATH = f"sqlite:///{os.path.join(BASE_DIR, 'record_manager_xls.sql')}"
...
# Search Path（搜尋路徑）
search_path = os.path.join(TARGET_DIR, "*.xlsx")
