...
print("===== 178_SQL_Record_Manager_CSV_RAG實驗 =====\n")
...
TARGET_DIR = os.path.join(BASE_DIR, "multi_csv")

# Database Directory（資料庫資料夾）
DB_DIR = os.path.join(BASE_DIR, "newsdb_csv")

# SQL Database Path（SQL 記錄檔）
SQL_DB_PATH = f"sqlite:///{os.path.join(BASE_DIR, 'record_manager_csv.sql')}"
...
# Query（查詢問題）
query = "臺北市政府交通局2022年與2023年YouBike相關資訊"
