...
| 資料夾名稱                         | 說明                                                            |
|----------------------------------------|-----------------------------------------------------------------|
| `Bert_embedding 程式截圖存放區`          | 用於存放 BERT_embedding 的程式截圖                        |
| `Finetune_Chinese_Weibo 程式截圖存放區` | 用於存放 Finetune_Chinese_Weibo 的程式截圖               |
| `PEFT_SFTTrainer 程式截圖存放區`        | 用於存放 PEFT_SFTTrainer 的程式截圖                           |
| `Pipeline_with_Deepseek_R1 程式截圖存放區` | 用於存放 Pipeline_with_Deepseek_R1 的程式截圖                              |
